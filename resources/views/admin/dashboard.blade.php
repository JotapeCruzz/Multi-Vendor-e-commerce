                        ...
                        <div class="card-body">
                            ...
                            <div class="direct-chat-messages">
                                ...
                                <div class="direct-chat-msg">
                                    ...
                                    <!-- /.direct-chat-infos --> <img class="direct-chat-img"
                                        src="{{ asset('admin/images/user1-128x128.jpg') }}" alt="message user image">
                                    <!-- /.direct-chat-img -->
                                ...
                                <div class="direct-chat-msg end">
                                    ...
                                    <!-- /.direct-chat-infos --> <img class="direct-chat-img"
                                        src="{{ asset('admin/images/user3-128x128.jpg') }}" alt="message user image">
                                    <!-- /.direct-chat-img -->
                                    <div class="direct-chat-text">
                                ...
                                <!-- /.direct-chat-msg --> <!-- Message. Default to the start -->
                                <div class="direct-chat-msg">
                                    <div class="direct-chat-infos clearfix"> <span class="direct-chat-name float-start">
                                            {{ Auth::guard('admin')->user()->name }}
                                        </span> <span class="direct-chat-timestamp float-end">
